...
function _entanglement_filtering(
    ...
    @plansor checkcontract = true TA[-1 -2; -3 -4] := TA[1 2; 3 4] * PR4[1; -1] * PL1[-2; 2] * PR2[4; -4] * PL3[-3; 3]
    @plansor checkcontract = true TB[-1 -2; -3 -4] := TB[1 2; 3 4] * PL2[-1; 1] * PR3[2; -2] * PL4[-4; 4] * PR1[3; -3]
