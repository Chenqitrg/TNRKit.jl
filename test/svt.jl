...
X_approx1, trunc_this1, error1 = weighted_low_rank(PhidPhi, PhidY, T, T, 16; method = "svt", maximum_steps=30, rtol=1.0e-8, verbosity = 3)
X_approx2, trunc_this2, error2 = weighted_low_rank(PhidPhi, PhidY, T, T, 16; method = "svd", maximum_steps=30, rtol=1.0e-8, verbosity = 3)
